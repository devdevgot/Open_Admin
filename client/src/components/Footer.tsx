        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-1 border-b border-[#FAF8F5]/10 pb-12 sm:border-0 sm:pb-0">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/avieraliving?igsh=MWUwZ25tNjJwaGRycQ==" target="_blank" rel="noopener noreferrer" className="text-[#FAF8F5]/70 hover:text-[#D8BFAE] transition-colors border-2 border-[#FAF8F5]/70 rounded-lg p-2 flex items-center justify-center" aria-label="Instagram">
                <Instagram size={20} />
              </a>
              <a href="https://www.linkedin.com/company/aviera-living/about/" target="_blank" rel="noopener noreferrer" className="text-[#FAF8F5]/70 hover:text-[#D8BFAE] transition-colors border-2 border-[#FAF8F5]/70 rounded-lg p-2 flex items-center justify-center" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61586981953546&sk=directory_offers" target="_blank" rel="noopener noreferrer" className="text-[#FAF8F5]/70 hover:text-[#D8BFAE] transition-colors border-2 border-[#FAF8F5]/70 rounded-lg p-2 flex items-center justify-center" aria-label="Facebook">
                <Facebook size={20} />
              </a>
            </div>
          </div>
          ...
          <div className="pb-8 sm:pb-0">
            ...
            <ul className="space-y-4 font-inria text-[#FAF8F5]/80 text-sm">
              ...
              <li className="pt-4"><a href="mailto:avieraliving@gmail.com" className="hover:text-[#FAF8F5] transition-colors">avieraliving@gmail.com</a></li>
