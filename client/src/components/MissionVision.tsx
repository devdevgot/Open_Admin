      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="border-t border-[#3D2716] pt-12">
            <h2 className="font-symphony text-6xl md:text-8xl text-[#3D2716] leading-none mb-1">Our</h2>
            <h3 className="font-lejour italic text-3xl text-[#995134] mb-8">Mission</h3>
          ...
          <div className="border-t border-[#3D2716] pt-12">
            <h2 className="font-symphony text-6xl md:text-8xl text-[#3D2716] leading-none mb-1">Our</h2>
            <h3 className="font-lejour italic text-3xl text-[#995134] mb-8">Vision</h3>
            <p className="font-inria text-lg text-[#3D2716]/80 leading-relaxed">
